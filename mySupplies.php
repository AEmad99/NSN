...
<?php include 'templates/header.php'; ?>
  ...
  <div class="row sticky2" style="visibility:hidden !important;" id="myUpdater">
        <div class="col s12" style="text-align:true;">
            <div class="row">
                <div class="input-field col s6" style="width:80% !important;">
                    <input placeholder="Supply Name" id="supply_name_update" type="text" class="validate">
                </div>
                <div class="input-field col s6" style="width:80% !important;">
                    <input placeholder="Supply Description" id="supply_description_update" type="text" class="validate">
                </div>
                <button class="brand btn" id="updateBtn" style="margin-top:20%">Confirm</button>
            </div>
        </div>
  </div>
    ...
    <div class="container center offers" id="offersContainer">
        ...
        <div class="sending">
            <button id="buttonOffer"> Accept Offer</button>
        </div>
    </div>
<script type="text/javascript" src="mySupplies.js"></script>
</html>